...
class ReturnExchangeController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('admin.back_to_school.returns.index', compact('requests', 'filters', 'productImages'));
    }
    ...
    public function show(ReturnExchangeRequest $returnRequest): View
    {
        ...
        return view('admin.back_to_school.returns.show', compact('returnRequest', 'product', 'sizes'));
    }
    ...
    public function generateExchange(Request $request, ReturnExchangeRequest $returnRequest): RedirectResponse
    {
        ...
        return redirect()->route('admin.back_to_school.returns-exchange.show', $returnRequest)->with('status', 'Exchange order generated');
    }
