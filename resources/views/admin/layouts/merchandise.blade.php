...
<head>
    ...
    <title>@yield('title', 'Merchandise Admin | The Skool Store')</title>
    ...
    <div class="layout">
        <aside class="sidebar">
            <div class="brand">
                ...
                <small>Merchandise Admin</small>
            </div>
            <nav class="nav">
                @php
                    $navItems = [
                        ['label' => 'Dashboard', 'route' => 'admin.merchandise.dashboard', 'icon' => 'fas fa-th-large'],
                        [
                            'label' => 'Product', 
                            'route' => 'admin.merchandise.products.index', 
                            'active' => 'admin.merchandise.products.*', 
                        ...
                        ['label' => 'Exchanges', 'route' => 'admin.merchandise.returns-exchange.index', 'active' => 'admin.merchandise.returns-exchange.*', 'icon' => 'fas fa-exchange-alt'],
                        ...
                        ['label' => 'Category Settings', 'route' => 'admin.merchandise.product-settings.index', 'active' => 'admin.merchandise.product-settings.*', 'icon' => 'fas fa-cog'],
                    ];
                @endphp
        ...
        <main class="content">
            <div class="topbar">
                ...
                <div style="display:flex;align-items:center;margin-left:auto;gap:16px;">
                    {{-- 
                    <a href="{{ route('admin.back_to_school.dashboard') }}" class="btn-vs-sm" style="font-size:13px; padding: 8px 16px; border-width: 1px;">
                        <i class="fas fa-exchange-alt me-1"></i> Switch to Back To School
                    </a> 
                    --}}
                    ...
                    <div class="profile-dropdown" id="profileDropdown">
                        <form method="POST" action="{{ route('store.admin.logout', ['guard' => 'merch_admin']) }}" style="margin:0;">
                            @csrf
