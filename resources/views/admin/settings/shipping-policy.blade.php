...
@section('title', 'Shipping Policy | The Skool Store')
@section('page_heading', 'Shipping Policy')
@section('page_subheading', 'Edit the Shipping Policy page content')
    ...
    <div class="card" style="max-width:1200px;margin:auto;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
            <div style="display:flex;align-items:center;gap:15px;">
                ...
                <h3 style="margin:0;color:#111827;">Shipping Policy</h3>
            </div>
        </div>


        <form method="POST" action="{{ route('master.admin.settings.shipping-policy.update') }}">
            @csrf
        ...
        <div style="margin-top:30px;padding:16px;background:#f0f9ff;border-radius:8px;border:1px solid #bae6fd;">
            ...
            <p style="margin:0;color:#075985;font-size:13px;">
                <a href="{{ route('frontend.shipping-policy') }}" target="_blank" style="color:#0284c7;text-decoration:underline;">
                    View the current Shipping Policy page →
                </a>
            </p>
        </div>
    </div>
