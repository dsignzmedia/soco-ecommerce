...
@section('title', 'Terms & Conditions | The Skool Store')
@section('page_heading', 'Terms & Conditions')
@section('page_subheading', 'Edit the Terms & Conditions page content')
    ...
    <div class="card" style="max-width:1200px;margin:auto;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
            <div style="display:flex;align-items:center;gap:15px;">
                ...
                <h3 style="margin:0;color:#111827;">Terms &amp; Conditions</h3>
            </div>
        </div>


        <form method="POST" action="{{ route('master.admin.settings.terms-conditions.update') }}">
            @csrf
        ...
        <div style="margin-top:30px;padding:16px;background:#f0f9ff;border-radius:8px;border:1px solid #bae6fd;">
            ...
            <p style="margin:0;color:#075985;font-size:13px;">
                <a href="{{ route('frontend.terms-conditions') }}" target="_blank" style="color:#0284c7;text-decoration:underline;">
                    View the current Terms &amp; Conditions page →
                </a>
            </p>
        </div>
    </div>
