...
@section('content')
    <section class="card" style="margin-bottom:20px;">
        ...
        <form class="filters" method="GET">
            ...
            <button type="button" onclick="window.location.href='{{ route('master.admin.catalog.index') }}'" class="btn-reset">Reset</button>
        </form>
    </section>
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        ...
        <a href="{{ route('master.admin.catalog.create') }}" style="padding:10px 20px;border-radius:9999px;background:#490d59;color:#fff;font-weight:600;font-size:14px;text-decoration:none;">+ Add Product</a>
    </div>
