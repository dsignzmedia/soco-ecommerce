...
<style>
    ...
    <section class="card" style="display:flex;justify-content:space-between;align-items:center;">
        ...
        <a href="{{ route('admin.back_to_school.orders.index') }}" style="color:#490d59;font-weight:600;">← Back to orders</a>
    </section>
    ...
    <section class="card" style="display:flex;gap:12px;flex-wrap:wrap;">
        <a href="{{ route('admin.back_to_school.orders.invoice', $order) }}" class="action-btn action-btn-primary">
            <i class="fas fa-file-invoice"></i>
            View invoice
        </a>
        <a href="{{ route('admin.back_to_school.orders.invoice.download', $order) }}" class="action-btn action-btn-secondary">
