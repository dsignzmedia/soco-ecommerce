...
@section('content')
    <section class="card" style="margin-bottom:20px;">
        ...
        <form class="filters" method="GET">
            ...
            <button type="button" onclick="window.location.href='{{ route('admin.back_to_school.products.index') }}'" class="btn-reset">Reset</button>
        </form>
    </section>

    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        <div class="export-links" style="display:flex;gap:8px;flex-wrap:wrap;">
            <a href="{{ route('admin.back_to_school.products.export', ['type' => 'csv'] + request()->query()) }}">Export CSV</a>
            <a href="{{ route('admin.back_to_school.products.export', ['type' => 'excel'] + request()->query()) }}">Export Excel</a>
            <a href="{{ route('admin.back_to_school.products.export', ['type' => 'pdf'] + request()->query()) }}">Export PDF</a>
        </div>
        <a href="{{ route('admin.back_to_school.products.create') }}" style="padding:10px 20px;border-radius:9999px;background:#490d59;color:#fff;font-weight:600;font-size:14px;text-decoration:none;">+ Add Product</a>
    </div>
