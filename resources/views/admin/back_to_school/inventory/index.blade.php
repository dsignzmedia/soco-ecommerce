...
@section('content')
    ...
    <div style="margin-bottom: 16px;">
        <a href="{{ route('admin.back_to_school.dashboard') }}" style="display: inline-flex; align-items: center; gap: 8px; padding: 8px 16px; border-radius: 8px; border: 1px solid #d0d5dd; color: #475467; text-decoration: none; font-weight: 500; background: white; transition: all 0.2s;">
                        ...
                        <div style="padding: 16px; border-top: 1px solid #e5e7eb;">
                            ...
                            <div style="display: grid; gap: 12px;">
                                ...
                                <div style="display: flex; align-items: center; gap: 12px; padding: 10px; background: white; border: 1px solid #e5e7eb; border-radius: 8px;">
                                    ...
                                    <form action="{{ route('admin.back_to_school.inventory.variant-stock.update', $product) }}" method="POST" style="display: flex; gap: 8px; align-items: center;" onsubmit="return updateVariantStock(event, {{ $variant->id }})">
                                        @csrf
