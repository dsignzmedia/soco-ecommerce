...
<body>
    <div class="login-card">
        ...
        <div class="login-card__form">
            ...
            <form action="{{ route('store.admin.login.submit') }}" method="POST" autocomplete="off">
                @csrf
                <div class="form-group">
                    <label for="email">Email or Phone</label>
                    <input type="text" id="email" name="email" placeholder="admin@example.com" value="{{ old('email') }}" required autofocus>
                </div>
                <div class="form-group">
             ...
             <p class="login-note" style="margin-top:16px;">
                <a href="{{ route('master.admin.login') }}" style="color:#490d59;text-decoration:none;">Master Admin Login →</a>
            </p>
        </div>
    </div>
</body>
