...
@section('title', 'Merchandise Dashboard | The Skool Store')
@section('page_heading', 'Merchandise Dashboard')
        ...
        <form method="GET" class="filter-form-grid">
            <div class="filter-row">
                ...
                <div style="display: flex; gap: 8px;">
                    ...
                    <button type="button" onclick="window.location.href='{{ route('admin.merchandise.dashboard') }}'" class="btn-reset" style="flex: 1;">Reset</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="kpi-grid">
        @php
            function getKpiStyleV2($label) {
                ...
                if (stripos($label, 'print') !== false) return ['icon' => 'fa-print', 'color' => 'kpi-blue'];
    ...
    <div class="dashboard-mid-section">
        ...
        <div class="quick-actions-card">
            ...
            <div class="actions-grid">
                <a href="{{ route('admin.merchandise.orders.index') }}" class="action-item">
                ...
                <a href="{{ route('admin.merchandise.reports.index') }}" class="action-item">
                ...
                <a href="{{ route('admin.merchandise.products.index') }}" class="action-item">
                ...
                <a href="{{ route('admin.merchandise.inventory.index') }}" class="action-item">
                ...
                <a href="{{ route('admin.merchandise.print-queue.index') }}" class="action-item">
                    <div class="action-icon bg-purple-light">
                        <i class="fa-solid fa-print"></i>
                    </div>
                    <div class="action-info">
                        <span class="action-title">Print Queue</span>
                        <span class="action-desc">Manage print jobs</span>
                    </div>
                    <i class="fa-solid fa-chevron-right action-arrow"></i>
                </a>
            </div>
        ...
        <div class="admin-tips-card">
            <div class="tips-title">Merchandise Workflow</div>
            <div class="tips-text">
                <strong>1. Product Management:</strong> Add and manage merchandise products.<br>
                <strong>2. Custom Printing:</strong> Handle print requests and queue management.<br>
                <strong>3. Order Processing:</strong> Track and fulfill custom orders.<br>
