...
@section('content')
    ...
    <section class="card" style="border: 1px solid #e5e7eb; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); padding:0;">
                ...
                <tbody>
                    @forelse($orders as $order)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.merchandise.orders.status', $order) }}" method="POST">
                                    @csrf
                            ...
                            <td style="text-align:right;">
                                <div style="display:flex; justify-content:flex-end; gap:6px;">
                                    <a href="{{ route('admin.merchandise.orders.show', $order) }}" class="btn-vs-sm" title="View Details">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.merchandise.orders.invoice', $order) }}" class="btn-vs-sm" title="View Invoice">
                                        <i class="fas fa-file-invoice"></i>
                                    </a>
                                    <a href="{{ route('admin.merchandise.orders.invoice.download', $order) }}" class="btn-vs-sm" title="Download Invoice">
