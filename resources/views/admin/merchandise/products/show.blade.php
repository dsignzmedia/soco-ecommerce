...
@section('content')
    <div style="display:flex;justify-content:flex-end;align-items:center;margin-bottom:24px;gap:12px;">
        <a href="{{ route('admin.merchandise.products.edit', $product) }}" style="padding:10px 16px;border-radius:12px;border:1px solid #d0d5dd;background:#fff;color:#490d59;font-weight:600;text-decoration:none;display:flex;align-items:center;gap:8px;">
