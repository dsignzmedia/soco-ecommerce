...
@section('content')
    <div style="display:flex;flex-direction:column;gap:24px;">
        <section class="card" style="display:flex;justify-content:space-between;align-items:center;">
            ...
            <a href="{{ route('admin.merchandise.products.index') }}" class="btn-back-outline">← Back to catalog</a>
        </section>
        ...
        <section class="card" style="display:flex;gap:12px;flex-wrap:wrap;">
            <a href="{{ route('admin.merchandise.products.edit', $product) }}" style="padding:10px 16px;border-radius:12px;border:1px solid #d0d5dd;color:#490d59;font-weight:600;">Edit product</a>
            <a href="{{ route('admin.merchandise.products.index', array_merge(request()->query(), ['status' => 'live'])) }}" style="padding:10px 16px;border-radius:12px;border:1px solid #d0d5dd;color:#475467;font-weight:600;">Back to list</a>
        </section>
    </div>
@endsection
