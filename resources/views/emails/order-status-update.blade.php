...
<title>Order Status Update - The Skool Store</title>
...
Great news, {{ $order->customer_name }}! @if($order->order_status === 'shipped')Your items have been shipped and are heading your way.@elseif($order->order_status === 'delivered')Your order has been successfully delivered.@elseif($order->order_status === 'packed')Your order has been packed and is ready for shipment.@else Your order status has been updated.@endif
</p>
...
{{ $order->order_date ? $order->order_date->addDays(5)->format('l, M d') : 'Soon' }}
</p>

<p style="margin:0;font-size:13px;color:#555;">
{{ $order->courier_name ?? 'Standard Shipping' }} &nbsp; | &nbsp;
Tracking #: <a href="#" style="color:#490D59;text-decoration:none;font-weight:bold;">{{ $order->tracking_number }}</a>
</p>

<!-- PROGRESS BAR -->
<div style="margin:12px 0;height:8px;background:#e5e7eb;border-radius:4px;">
<div style="width:66%;height:8px;background:#490D59;border-radius:4px;"></div>
</div>
...
<tr>
<td align="center">
<a href="#" style="display:block;background:#490D59;color:#ffffff;font-weight:bold;padding:12px;border-radius:6px;text-decoration:none;">
Track Your Package
</a>
</td>
</tr>
...
<p style="font-size:11px;color:#9a6c4c;font-weight:bold;text-transform:uppercase;">Shipped To</p>
...
<p style="font-size:11px;color:#9a6c4c;font-weight:bold;text-transform:uppercase;">Shipping Method</p>
<p style="margin:0;font-weight:bold;">{{ $order->courier_name ?? 'Standard Shipping' }}</p>
<p style="margin:0;">@if($order->order_status === 'shipped')In Transit@else Processing@endif</p>
</td>
